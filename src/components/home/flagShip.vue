...
.InformationTitle .Ivg {
  width: 50px;
  height: 50px;
  border-radius: 50%;
  background-color: #51b118;
  display: flex;
  justify-content: center;
  align-items: center;
  color: white;
